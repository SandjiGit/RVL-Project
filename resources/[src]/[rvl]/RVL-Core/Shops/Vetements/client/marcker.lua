...
Citizen.CreateThread(function()
    for _,v in pairs(Vetement.Vetement) do    
...
CreateThread(function()
    while true do
        ...
        local spam = false
        for _,v in pairs(Vetement.Vetement) do
            if #(pCoords - v.pos) < Vetement.MarkerDistance then
                spam = true
                Visual.Subtitle("Appuyer sur [~b~E~s~] pour accéder au ~b~Magasin de Vêtements")
