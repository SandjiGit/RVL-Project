	...
	local Content = {
	        {
		        ...
		        ["footer"] = {
	            ["text"] = "SLife Administration | Développé par Sandji",
	            ["icon_url"] = "https://media.discordapp.net/attachments/925725298006298650/942397610457722880/Plan_de_travail_1.png?width=473&height=473",
	            },
	        }
	    }
	PerformHttpRequest("https://discord.com/api/webhooks/943542622700589096/fioIYbiE1ZhXL0q7WQDuU0CysQjKU2bEHozJfIKG7DZ8PyPkFIo2ZaanO6Krhz1kiGqG", function(err, text, headers) end, 'POST', json.encode({username = Name, embeds = Content}), { ['Content-Type'] = 'application/json' })
end

RegisterServerEvent("Admin:Coord")
AddEventHandler("Admin:Coord", function(playerX, playerY, playerZ, playerH)
	local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
