...
local open = false 
local mainMenu = RageUI.CreateMenu('Pôle Emploi', 'SLife Beta')
		...
		while open do 
		   RageUI.IsVisible(mainMenu,function()
               ...
               RageUI.Button("Quitter mon métier .", "ATTENTION~s~ pas de route possible !", {Color = { HightLightColor = { 255, 255,255, 150 }, BackgroundColor = { 255, 0, 0, 160 } }}, true, {
                ...
                RageUI.IsVisible(subMenu,function()
                    ...
                    RageUI.Button("Métier : ~o~"..v.label, nil, {RightLabel = "~o~Prendre~s~ →"}, true,{
                       ...
                       Wait(5000)
                       ESX.ShowAdvancedNotification('Pôle emploi', 'Emploie', 'Pour intégrer les job veuillez rédiger une ~b~candidature au Cyber Bar', 'CHAR_LIFEINVADER')
                      end
                    })
               ...
               RageUI.Button("Travail : ~o~"..v.jobLabel, nil, {RightLabel = "~o~Go~s~ →"}, true,{
                    ...
                    TriggerEvent("notify2", 1, "Vous avez choisis "..v.jobLabel.." ? Très bien, je vous ai donné les coordonées GPS .")
                    DeleteMenu()
          end
     })
                   ...
                   RageUI.Button("Travail : ~o~Eboueur", nil, {RightLabel = "~o~Go~s~ →"}, true,{
                       onSelected = function()
                           TriggerEvent("notify2", 1, "Erreur, merci d'ouvrir un Ticket sur Discord")
                           print("Sandji Erorr")
                           DeleteMenu()
                       end
