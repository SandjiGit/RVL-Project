...
local open = false 
local mainMenu8 = RageUI.CreateMenu('LCHD', 'Interaction')
local subMenu8 = RageUI.CreateSubMenu(mainMenu8, "LCHD", "Annonces")
local subMenu9 = RageUI.CreateSubMenu(mainMenu8, "LCHD", "Interaction Citoyen")
local subMenu10 = RageUI.CreateSubMenu(mainMenu8, "LCHD", "Information Appel")
