...
AddEventHandler('playerSpawned', function()
	...
	if FirstSpawn then
		...
		ESX.TriggerServerCallback('esx_ambulancejob:getDeathStatus', function(isDead)
			if isDead and Config2.AntiCombatLog then
...
function StartDistressSignal()
	Citizen.CreateThread(function()
		local timer = Config2.BleedoutTimer
...
function StartDeathTimer()
	...
	if Config2.EarlyRespawnFine then
	...
	local bleedoutTimer = ESX.Math.Round(Config2.BleedoutTimer / 1000)
	...
	Citizen.CreateThread(function()
		...
		while bleedoutTimer > 0 and IsDead do
			...
			if not Config2.EarlyRespawnFine then
			...
			elseif Config2.EarlyRespawnFine and canPayFine then
				text = text .. _U('respawn_bleedout_fine', ESX.Math.GroupDigits(Config2.EarlyRespawnFineAmount))
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		local formattedCoords = {
			x = Config2.RespawnPoint.coords.x,
			y = Config2.RespawnPoint.coords.y,
			z = Config2.RespawnPoint.coords.z
		}
