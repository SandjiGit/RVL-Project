...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/JxtoC8E.png",
...
Config.Languages = {
  ...
  ['fr'] = {
        ...
        ['cancelemote'] = "✋ Arréter l'Animation",
        ...
        ['moods'] = "😀 Humeurs",
        ['infoupdate'] = "🗽 SLife Béta",
        ['infoupdateav'] = "SLife Béta",
        ['infoupdateavtext'] = "SLife Béta",
        ['suggestions'] = "Suggestions?",
        ['suggestionsinfo'] = "'dullpear_dev' SLife Béta",
        ...
        ['shareemotes'] = "👬 Animations à plusieurs",
        ['shareemotesinfo'] = "Inviter une personne proche à emoter",
        ['sharedanceemotes'] = "🕺 Animations partagées",
        ...
        ['keybinds'] = "#️⃣ Touches Raccourcis",
        ['keybindsinfo'] = "Use"
  },
  ['de'] = {
        ['emotes'] = 'Emotes',
