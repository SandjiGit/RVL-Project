     ...
     if open then 
         ...
         while open do 
            RageUI.IsVisible(mainMenu6,function() 
                ...
                RageUI.Separator("↓ ~g~Tenues Civil ~s~↓")

                RageUI.Button("Reprendre sa tenue : ~g~Civil", nil,{RightLabel = "→"}, true,{
                    onSelected = function()
              ...
              RageUI.Button("S'équiper d'un : ~y~Équipement", nil,{RightLabel = "→"}, true,{
                ...
                for _,infos in pairs(Config.Gouvernement.clothes.grades) do
